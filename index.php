        ...
        <div id="banner" class="full">
            <div class="wrapper" style="position: relative;">
                <div class="text-content col">
                    ...
                    <h2>19. JUNI 2025</h2>
                    <h3>WERDE TEIL VON OUTPUT UND<br> REICHE DEIN PROJEKT BIS 6. JUNI EIN!</h3>
                    <button class="white transparent-text mt-3" onclick="location.href='/projekt-einreichen'">PROJEKT
                        EINREICHEN</button>
                </div>
            </div>
        </div>
    ...
    <div class="light-bg">
        <div class="main wrapper">
            ...
            <div class="text-wrapper dark-bg col gap-2">
                ...
                <p>
                    Einmal im Jahr präsentieren Studenten und Mitarbeiter ihre Ergebnisse aus Lehre und Forschung der
                    Öffentlichkeit.
                    Dich erwarten spannende Installationen, Workshops, Vorträge und Ausstellungen.
                    Zudem bietet OUTPUT.DD die Gelegenheit, mit Unternehmen über aktuelle Forschungsfragen ins Gespräch
                    zu kommen.
                </p>
                <p class="fat">
