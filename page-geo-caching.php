            ...
            <div class="col gap-1">
                ...
                <table class="slim">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>OSMAND</td>
                            <td><a class="color-magenta"
                                    href="https://play.google.com/store/apps/details?id=net.osmand">Play-Store</a></td>
                            <td>
                                + kein Setup nötig<br>
                        ...
                        <tr>
                            <td>c:geo</td>
                            <td><a class="color-magenta"
                                    href="https://play.google.com/store/apps/details?id=cgeo.geocaching">Play-Store</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><a class="color-magenta"
                                    href="https://play.google.com/store/apps/details?id=com.groundspeak.geocaching.intro">Play-Store</a>
                            </td>
                            <td>
